...
def main_flow_gcp(
    ...
    # Load
    gcp_cloud_storage_bucket_block = GcsBucket.load("mlops-zoomcamp-bucket")
    gcp_cloud_storage_bucket_block.download_folder_to_path(from_folder="data", to_folder="data")
